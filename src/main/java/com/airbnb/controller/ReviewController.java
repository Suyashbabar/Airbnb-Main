...
public class ReviewController {
    ...
    public ReviewController(ReviewRepository reviewRepository, PropertyRepository propertyRepository, UserService userService) {
    ...
    public ResponseEntity<String> addReview(
            ...
            @RequestBody Review review, @AuthenticationPrincipal PropertyUser user){
        ...
        if (r!=null){
            return new ResponseEntity<>("You have already added the response" , HttpStatus.BAD_REQUEST);
        }
